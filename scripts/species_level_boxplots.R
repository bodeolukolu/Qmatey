...
for (perc in c(percent_thresh)) {
  ...
  uniq_box<-function(df, dfu){
    ...
    htmlwidgets::saveWidget(as_widget(u), paste("species_level_unique_reads_",perc,"perc.html",sep=""), selfcontained=FALSE)
  }
  uniq_box(df, dfu)
  ...
  error_box<-function(df, dfe){
    ...
    htmlwidgets::saveWidget(as_widget(u), paste("species_level_errors_",perc,"perc.html",sep=""), selfcontained = FALSE)
  }
  error_box(df, dfe)
  ...
  rel_error_box<-function(df, dfre){
    ...
    htmlwidgets::saveWidget(as_widget(u), paste("species_level_rel_errors_",perc,"perc.html",sep=""), selfcontained = FALSE)
  }
