...
for (perc in c(percent_thresh)) {
  data.pipe<-function(dfm,dfu,dfe,dfre,cut){
    ...
    met<-dfm
    met<-subset.data.frame(met, select=-c(tax_id,species,genus,family,order,class,phylum,kingdom,domain))
  ...
  uniq_box<-function(df, dfu){
    ...
    htmlwidgets::saveWidget(as_widget(u), paste("strain_level_unique_reads_",perc,"perc.html",sep=""), selfcontained=TRUE)
  }
  uniq_box(df, dfu)
  ...
  mean_box<-function(df, dfm){
    ...
    htmlwidgets::saveWidget(as_widget(u), paste("strain_level_mean_reads_",perc,"perc.html",sep=""), selfcontained=TRUE)
  }
  mean_box(df, dfm)
  ...
  error_box<-function(df, dfe){
    ...
    htmlwidgets::saveWidget(as_widget(u), paste("strain_level_errors_",perc,"perc.html",sep=""), selfcontained=TRUE)
  }
  error_box(df, dfe)
  ...
  rel_error_box<-function(df, dfre){
    ...
    htmlwidgets::saveWidget(as_widget(u), paste("strain_level_rel_errors_",perc,"perc.html",sep=""), selfcontained=TRUE)
  }
