...
|reads_per_megablast|10000 or 100|batch size of sequences per thread during MegaBLAST: 10000 for RRS/WGS and 100 for 16S/ITS/amplicon|integer|Optional|
|reads_per_megablast_burn_in|10000 or 100|batch size of representative sequences per thread during MegaBLAST when reducing database|integer|Optional|
